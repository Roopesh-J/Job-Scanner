...
SYSTEM_PROMPT = (
    ...
    "just flattering.\n\n"
    "Write every insight's text as if speaking directly to the candidate — use "
    "'you'/'your' ('You have hands-on experience with...', 'You're missing "
    "experience with...'). Never refer to them in the third person ('the "
